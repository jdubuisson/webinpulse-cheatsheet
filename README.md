# Références Git pour Webinpulse
...
* Comment récupérer les "nouveautés" du dépôt distant ? Réponse Florian: recuperer_nouveautes_depot_distant.md 
* Comment récupérer une branche distante ? Réponse Florian: depot_distant_changements.md
